...
$(function() {
    ...
    $('.main-slide-div').mouseenter(function() {
        $(this).dequeue().find('.description').fadeIn(500);
        $(this).dequeue().find('.get-consultant-btn').fadeIn(500);
    });

    $('.main-slide-div').mouseout(function() {
        $(this).dequeue().find('.description').fadeOut(500);
        $(this).dequeue().find('.get-consultant-btn').fadeOut(500);
    });
