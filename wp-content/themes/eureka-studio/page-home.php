...
<div class="main-banner"
    style="background: url(<?php echo wp_get_attachment_image_src(get_field('index_banner'), 'full')[0];?>) center center;background-size: cover;width: 100vw;">
...
<div class="mt-lg-5 mt-md-5 mt-sm-4 mt-4">
    ...
    <div class="container mt-lg-5 mt-md-5 mt-sm-4 mt-4">
        <div class="row">
            ...
            m-12 col-12 mb-lg-0 mb-md-0 mb-sm-4 mb-4"><a href="<?php echo get_permalink();?>" class="work-a">
                ...
                <div><?php echo get_the_title();?>
                    ...
                    <ul class="tag-ul d-block mt-2 text-start">
                        <?php
    ...
    <div class="mt-lg-5 mt-md-5 mt-sm-4 mt-4 mb-5">
        ...
        if ( $the_query->have_posts() ) {
            while ( $the_query->have_posts() ) {
                ...
                // echo 1;
                ?>
                <div class="col-lg-3 col-md-3 col-sm-4 col-6 mb-0 client-logo-col">
                    <!-- <a href="#" class="work-a"> -->
